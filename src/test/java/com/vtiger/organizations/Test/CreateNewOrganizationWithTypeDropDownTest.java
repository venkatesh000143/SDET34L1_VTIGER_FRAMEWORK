...
public class CreateNewOrganizationWithTypeDropDownTest extends BaseClass {
	@Test
	public void createNewOrganizationWithTypeDropDownTest()
	{
		...
		createNewOrganizationPage.clickOrganizationTypeDropDown();		
	}}